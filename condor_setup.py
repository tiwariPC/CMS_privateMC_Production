...
listOfFilesToTransfer = 'EXO-RunIISummer15wmLHEGS-07001_1_cfg.py, EXO-RunIISummer16DR80Premix-14550_1_cfg.py, EXO-RunIISummer16DR80Premix-14550_2_cfg.py, EXO-RunIISummer16MiniAODv3-12502_1_cfg.py, dummyFile'
...
for key in sampleLists.models:
  ...
  if key == 'bbdm':
    for gridpcaks in sampleLists.models[key]:
        ...
        condorJobHelper.Arguments = 'EXO-RunIISummer15wmLHEGS-07001_1_cfg.py '+DirName + \
